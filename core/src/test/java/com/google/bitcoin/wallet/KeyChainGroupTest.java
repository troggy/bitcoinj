...
public class KeyChainGroupTest {
    ...
    public void findRedeemScriptFromPubHash() throws Exception {
        ...
        assertTrue(group.findRedeemDataFromPubHash(address.getHash160()) != null);
        ...
        for (int i = 0; i < LOOKAHEAD_SIZE + group.getLookaheadThreshold(); i++) {
            ...
            assertTrue(group2.findRedeemDataFromPubHash(address.getHash160()) != null);
        }
        assertFalse(group2.findRedeemDataFromPubHash(group.freshAddress(KeyChain.KeyPurpose.RECEIVE_FUNDS).getHash160()) != null);
    }
